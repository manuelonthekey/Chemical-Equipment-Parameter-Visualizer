...
INSTALLED_APPS = [
    ...
    # Third-party apps
    'rest_framework',      # For the API [cite: 8]
    'rest_framework.authtoken',
    'corsheaders',         # To allow React to connect 

    # Local apps
    'api',                 # Your custom app for logic
]
...
# Database
# Using SQLite as required [cite: 11]
DATABASES = {
    'default': {
...
# CORS Configuration
# Allows the React Frontend (usually port 3000) to access the API
